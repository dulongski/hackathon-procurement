...
const WORDS = ["Smart", "AI", "Procurement", "Sourcing", "Transparent", "Auditable", "Fast"];
...
function TypewriterSubtitle() {
  ...
  return (
    <p className="text-ciq-darkgrey text-center mb-8 text-lg">
      Simply <span className="text-ciq-red font-bold">{displayed}</span>
      <span className="animate-pulse text-ciq-red">|</span>
    </p>
  );
}
